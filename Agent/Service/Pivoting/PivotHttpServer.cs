...
namespace Agent.Service.Pivoting
{
    public class PivotHttpServer
    {
        ...
        public PivotHttpServer(int bindPort, bool isSecure = true, string bindAddress = null)
        {
            _bindPort = bindPort;
            _bindAddress = bindAddress ?? "127.0.0.1";
            _isSecure = isSecure;
        ...
        public async Task Start()
        {
            ...
            string url = "http://" + _bindAddress + ":" + this._bindPort + "/";
            if (this._isSecure)
            {
